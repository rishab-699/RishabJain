...
const projectsPage = ()=>{
    ...
    return(
        <div className="p-4">
            {projectform && <Addprojects setprojectform={setprojectform}/>}
            project Page
            <button type="button" className="px-4 py-2 bg-blue-900 text-white rounded-lg hover:bg-blue-950 hover:font-bold text-center" 
                    ...
                    {project.length > 0 ? (
                      project.map((item, index) => {
                        ...
                        return (
                          <div
                            key={index}
                            className="relative rounded-lg overflow-hidden shadow-md bg-gray-100 cursor-pointer"
                            style={{
                        ...
                        ">
                            <div className="bg-white rounded-xl w-fit max-w-[80%] relative flex flex-wrap items-center justify-center p-4 md:p-8">
                                ...
                                <div
                                    ...
                                    style={{
                                    width: "480px", // fixed column width
                                ...
                                <div className="w-full md:w-1/2 flex flex-col gap-4 p-4">
                                    ...
                                    <span className="text-xl">{singleImg.description}</span>
                                    <Link href={singleImg.link || '#'} className="px-2 py-4 w-fit text-xl text-white bg-black rounded-xl hover:scale-105 active:scale-100">Read Docs</Link>
                                </div>
                            </div>
                        </div>
                    }
